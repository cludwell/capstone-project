...
export default function AboutPage() {
    ...
    return (
        ...
        <img src="https://skillicons.dev/icons?i=js,html,css,docker,express,flask,git,nodejs,nextjs,postgres,postman,prisma,py,react,redux,sequelize,tailwind,ts,vscode&perline=8&theme=light"  alt="" className="skill-icons"/>
