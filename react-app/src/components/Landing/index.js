...
export default function Landing() {
  ...
  return (
    <div className="landing-container">
      {!user ? (
        <div className="updated-use-terms">
      ...
      <div className="landing-banner">
        <div className="landing-banner-main">
          ...
          <h2 className="landing-banner-subtitle">
            New Wave Punk Rockers from Madrid
          </h2>
          <NavLink to={`/bands/${albums["8"].bandId}`}>
            <img
              className="landing-banner-main-photo mt-10"
        ...
        <div className="landing-banner-column">
          <h4 className="landing-banner-mid-col">
            Fellowship carries DragonForce's torch
          </h4>
          <h4 className="landing-banner-bottom-col">
